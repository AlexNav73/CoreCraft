...
namespace compilation.LoadManually
{
    ...
    internal sealed partial class FakeModelShardView : global::System.IDisposable
    {
        ...
        public FakeModelShardView(IDomainModel model)
        {
            ...
            ThirdCollection = builder.Create(static shard => shard.ThirdCollection, static frame => frame.ThirdCollection);
        ...
        public ICollectionView<ThirdEntity, ThirdEntityProperties> ThirdCollection { get; private set; }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverageAttribute()]
    internal sealed partial class LazyShardModelShardView : global::System.IDisposable
    {
        private bool _disposed = false;
